...
CREATE TABLE `bookings` (
  ...
  PRIMARY KEY (`b_id`),
  KEY `bookings_ibfk_1` (`Ticket_no`),
  CONSTRAINT `bookings_ibfk_1` FOREIGN KEY (`Ticket_no`) REFERENCES `ticket_issue` (`Ticket_no`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `bookings` VALUES (1,3,'2','24','Suraj','paid',''),(2,3,'2','24','Suraj','paid',''),(3,3,'1','12','Suraj','paid',''),(5,3,'1','12','Suraj','paid',''),(7,4,'20','6000','Suraj','paid',''),(8,4,'1','300','Suraj','paid',''),(9,5,'2','400','Suraj','paid',''),(26,6,'1','40','Suraj','paid',''),(27,6,'1','40','Suraj','paid','');
...
CREATE TABLE `paymentdetail` (
  ...
  PRIMARY KEY (`s.n`),
  KEY `paymentdetail_ibfk_1` (`bookingid`),
  CONSTRAINT `paymentdetail_ibfk_1` FOREIGN KEY (`bookingid`) REFERENCES `bookings` (`b_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `paymentdetail` VALUES (1,3,'0','2022-04-20'),(2,3,'0','2022-04-20'),(3,3,'0','2022-04-20'),(4,3,'0','2022-04-20'),(5,3,'0','2022-04-20'),(6,3,'0','2022-04-20'),(7,1,'0','2022-04-20'),(8,1,'0','2022-04-20'),(9,1,'0','2022-04-20'),(10,3,'0','2022-04-20'),(11,3,'0','2022-04-20'),(12,3,'1','2022-04-20'),(13,2,'0','2022-04-20'),(14,2,'0','2022-04-20'),(15,2,'0','2022-04-20'),(16,3,'0','2022-04-20'),(17,3,'0','2022-04-20'),(18,3,'0','2022-04-20'),(19,1,'0','2022-04-20'),(20,1,'0','2022-04-20'),(21,1,'0','2022-04-20'),(22,1,'0','2022-05-02'),(23,1,'0','2022-05-25'),(24,1,'0','2022-05-25'),(25,1,'0','2022-05-26'),(27,1,'1','2022-05-27'),(28,1,'s','2022-05-27'),(29,1,'s','2022-05-27'),(30,7,'s','2022-05-27'),(31,7,'s','2022-05-27'),(32,5,'s','2022-05-27'),(33,5,'s','2022-05-27');
...
INSERT INTO `ticket_issue` VALUES (3,'sas','4','5df','2022-04-16','6 am','12','fsd','s','Raman'),(4,'football match u-16','150','dashrath stadium','2022-05-30','4:30 pm','300','ANFA','s','dipesh'),(5,'futsal cup 2022','100','samakhushi','2022-06-12','10 am','200','samakhushi futsal','s','Ramesh'),(6,'open tennis ','5','handball ground','2022-06-07','10 am','40','Handball comunity','s','Raman');
...
-- Dump completed on 2022-08-18 15:42:57
